...
export const getFeaturedProducts = async (req, res) => {
  try {
    ...
    // .lean() is gonna return a plain js boject instead of a mongodb document
...
export const deleteProduct = async (req, res) => {
  try {
    ...
    res.json({ message: "Product deleted successfully" })  // send success message to client
...
export const toggleFeaturedProduct  = async (req,res) => {
  try {
    const product = await Product.findById(req.params.id)
    if(product) {
      product.isFeatured = !product.isFeatured //toggled product
